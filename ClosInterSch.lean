...
noncomputable def PreClos.interSub (W Z : PreClos X)
    (e : W.indnumb ≃ Z.indnumb) (i : W.indnumb) : Scheme :=
...
instance PreClos.interSub_snd (W Z : PreClos X)
    (e : W.indnumb ≃ Z.indnumb) (i : W.indnumb) (γ : W.cov.J) :
...
noncomputable def PreClos.interIdeal (W Z : PreClos X)
    (e : W.indnumb ≃ Z.indnumb) (i : W.indnumb) (γ : W.cov.J) :
    Ideal (W.cov.obj γ) :=
  (IsClosedImmersion.Spec_iff.mp (W.interSub_snd Z e i γ)).choose

noncomputable def PreClos.interIso (W Z : PreClos X)
    (e : W.indnumb ≃ Z.indnumb) (i : W.indnumb) (γ : W.cov.J) :
...
noncomputable def PreClos.inter (W Z : PreClos X)
    (e : W.indnumb ≃ Z.indnumb) : PreClos X where
  indnumb := W.indnumb
...
theorem PreClos.interChartIso_hom_snd (W Z : PreClos X) (e : W.indnumb ≃ Z.indnumb)
  ...
  simp [PreClos.interChartIso, pullback.cube₀, pullback.klotski₀, pullback.squash₄]
